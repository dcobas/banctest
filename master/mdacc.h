...
/* missing.c */
extern int set_rx_buf(short bc, short rt, short bcnt, char *buf, unsigned short *sta);
extern int get_rx_buf(short bc, short rt, short bcnt, char *buf, unsigned short *sta);
extern int set_tx_buf(short bc, short rt, short bcnt, char *buf, unsigned short *sta);
extern int get_tx_buf(short bc, short rt, short bcnt, char *buf, unsigned short *sta);
extern int get_csr(short bc, short rt, unsigned short *csr, unsigned short *sta);
extern int set_csr(short bc, short rt, unsigned short *csr, unsigned short *sta);
extern int clr_csr(short bc, short rt, unsigned short *csr, unsigned short *sta);
extern int stop_poll(void);
/* print.c */
